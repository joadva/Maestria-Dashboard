...
const Pagos = React.lazy(() => import("./views/Pagos/Pagos"));
const Mapa = React.lazy(() => import("./views/Mapa/Mapa"));
...
const routes = [
  ...
  { path: "/pagos/pagos", exact: true, name: "Pagos", component: Pagos },
  { path: "/Mapa/Mapa", exact: true, name: "Mapa", component: Mapa },
  {
